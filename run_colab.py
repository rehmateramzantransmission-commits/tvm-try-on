...
subprocess.run([sys.executable, "-m", "pip", "install", "-q", "pyngrok", "gradio_client", "fastapi", "uvicorn[standard]", "websockets", "mediapipe", "opencv-python-headless", "pillow", "numpy", "diffusers", "transformers", "accelerate", "peft", "fal-client", "PyTurboJPEG", "controlnet-aux", "torchao"], check=True)
